...
/**
 * This class implements the graphics that's shows the analog clock.
 * 
 * @author Klas Jönsson
 *
 */
public class EggTimer extends JPanel implements ActionListener {

	private static final long serialVersionUID = 2L;
	// The stuff that are needed
	private Timer tim = new Timer(1000, this);
	private int s=0,m=0,h=0, t=0;
	private Boolean paused = false, countUp = false, digitalTime = false;
	...
	public void actionPerformed(ActionEvent e){
		...
		if (t == 0 && !countUp){
			...
			h=m=s=0;
			repaint();
			PlaySound PS = new PlaySound(alarmSound); 
		}
	 ...
	 * @param cu
	 */
	public void start(int startTime, Boolean cu){
		t = startTime;
		if (t != 0){
			h = t/3600*5;
			m = (t-h*3600/5)/60;
	...
	public void pause() {
		...
		//System.out.println("ET.paused="+paused);
	} // End of method pause
	...
	public void setAlarm(int time){
		alarmTime = time;
		alarmOn = !alarmOn;
		//System.out.println("ET.alarmOn=" + alarmOn);
	}
